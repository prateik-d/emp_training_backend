    ...
    <div class="" id="video" style="display: none;">
        ...
        <div class="" id = "video_upload" style="display: none;">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" data-toggle='timepicker' data-minute-step="5" name="video_upload_duration" id = "video_upload_duration" data-show-meridian="false" value="00:00:00">
            </div>

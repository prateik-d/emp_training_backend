                            ...
                            <div id="basicwizard">
                                                        ...
                                                        <div id = "blank_outcome_field">
                                                            <div class="d-flex mt-2">
                                                                <div class="flex-grow-1 px-3">
                                                                    <div class="form-group">
                                                                        <input type="text" class="form-control" name="outcomes[]" id="outcomes" placeholder="<?php echo get_phrase('provide_outcomes'); ?>">
                                                                        <input type="hidden" class="custom-control-input" name="is_free_course" id="is_free_course" value="1" checked="checked">
                                                                    </div>
                                                                </div>
                                                                <div class="">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-xl-8">
                                            <div class="form-group row mb-3">
                                                <div class="offset-md-2 col-md-10">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input" name="is_free_course" id="is_free_course" value="1" checked="checked" onclick="togglePriceFields(this.id)">
                                ...
                                <div class="tab-pane" id="media">
                                    <div class="row justify-content-center">
                                            ...
                                            <div class="form-group row mb-3">
                                                ...
                                                <div class="col-md-10">
                                                    <select class="form-control select2" data-toggle="select2" name="course_overview_provider" id="course_overview_provider" onchange="toggle_video_div(this.value);">
                                                        ...
                                                        <option value="video_upload"><?php echo get_phrase('Video Upload'); ?></option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div> <!-- end col -->
                                        ...
                                        <div class="col-xl-8 video_file_upload_div" style="display: none;">
                                            <div class="form-group row mb-3">
                                        ...
                                        <div class="col-xl-8 video_url_div">
                                            <div class="form-group row mb-3">
                                        ...
                                        <div class="col-xl-8">
                                            <div class="form-group row mb-3">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <input type="text" class="form-control" id = "meta_keywords" name="meta_keywords" style="width: 100%;"/>
                                                </div>
                                            </div>
                                        </div> <!-- end col -->
                                        <div class="col-xl-8">

...
<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-arrow-right-circle-outline title_icon"></i> <?php echo get_phrase('dashboard'); ?>
                </h4>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="header-title mb-4"><?php echo get_phrase('admin_revenue_this_year').' ('.currency_code_and_symbol('code').')'; ?></h4>
                <div id="chartdiv"></div>

                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-xl-8">
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-md-10">
                                            <select class="form-control select2" data-toggle="select2" name="course_overview_provider" id="course_overview_provider" onchange="toggle_video_div(this.value);">
                                                ...
                                                <option value="video_upload" <?php if ($course_details['course_overview_provider'] == 'video_upload')echo 'selected';?> ><?php echo get_phrase('Video Upload'); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div> <!-- end col -->
                                ...
                                if ($course_details['course_overview_provider'] == 'video_upload')
                                {
                                   $video_file_upload_div_display= '';
                                   $video_url_div='display: none;';
                                }

                                else
                                {
                                    $video_file_upload_div_display= 'display: none;';
                                    $video_url_div='';
                                }
                               ...
                               <!-- start of video upload -->
                                        ...
                                        <div class="col-xl-8 video_file_upload_div" style="<?= $video_file_upload_div_display; ?>">
                                            <div class="form-group row mb-3">
                                                <label class="col-md-2 col-form-label" for="course_overview_url"><?php echo get_phrase('upload_video'); ?></label>
                                                <div class="col-md-10">
                                                    <input type="file" class="form-control" name="upload_video_file" id="upload_video_file" >
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xl-8 video_url_div" style="<?= $video_url_div; ?>">
                                    <div class="form-group row mb-3">
                                ...
                                <div class="col-xl-8">
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <input type="text" class="form-control" id = "meta_keywords" name="meta_keywords" style="width: 100%;" value="<?php echo $course_details['meta_keywords']; ?>"/>
                                        </div>
                                    </div>
                                </div> <!-- end col -->
                                <div class="col-xl-8">
...
<script type="text/javascript">
    ...
    function toggle_video_div(val)
    {
        var course_overview_provider = val;

        if(course_overview_provider=="video_upload")
        {
           $(".video_url_div").hide();
           $(".video_file_upload_div").show();
        }

        else
        {
           $(".video_url_div").show();
           $(".video_file_upload_div").hide();
        }

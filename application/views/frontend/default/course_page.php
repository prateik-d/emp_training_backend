      ...
      <div class="preview-video-box">
        <a data-toggle="modal" data-target="#CoursePreviewModal">
          <?php 
              ...
              $thumbnail =  $this->courses_model->get_course_from_id($course_details['id']); 
          ...
          <?php 
                  ...
                  {
          ?>
                     <img src="<?php echo base_url().'/uploads/thumbnails/course_thumbnails/'.$thumbnail->thumbnail ?>" alt="" class="img-fluid">

                  ...
                  <div class="user-dashboard-content w-100 register-form">
                      ...
                      <form action="<?php echo site_url('login/register'); ?>" method="post">
                          <div class="content-box">
                              <div class="basic-group">
                                <div class="form-group">
                                      <label for="role_id"><span class="input-field-icon"><i class="fas fa-user"></i></span> <?php echo get_phrase('sign_up_as'); ?>:</label>
                                      <select name="role_id" id="role_id" class="form-control" style="padding-top: 6px;">

            ...
            <div class="col-lg-9" id = "video_player_area">
                ...
                <div class="" style="text-align: center;">
                    ...
                    if($lesson_details['lesson_type'] == 'video' || $lesson_details['lesson_type'] == '' || $lesson_details['lesson_type'] == NULL):
                        ...
                        <!-- If the video is uploaded video -->
                        ...
                        <!------------- PLYR.IO ------------>
                            ...
                            <?php if (get_video_extension($s3_video_url) == 'mp4'): ?>
                                <source src="<?php echo $s3_video_url; ?>" type="video/mp4">
                                <?php elseif (get_video_extension($s3_video_url) == 'webm'): ?>
                        ...
                        <!-- end of If the video is uploaded video -->
